...
/*   Updated: 2023/05/04 18:28:27 by tkempf-e         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Convert::Convert(Convert &src) : _str(src._str), _int(src._int), _float(src._float), _double(src._double), _char(src._char), _isChar(src._isChar), _isInt(src._isInt), _isFloat(src._isFloat), _isDouble(src._isDouble)
{
	*this = src;
}
